...
class Customer(models.Model):
    ...
    user = models.OneToOneField(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, default='0000000')
...
class OrderItem(models.Model):
    ...
    unity_price = models.DecimalField(max_digits=6, decimal_places=6)
...
class Cart(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid4, max_length=255)
